  ...
  return (
    ...
    >
      <AnimatedSection direction="right" stagger={0.2} className="flex flex-col items-center gap-6">
        ...
        <p className="text-black dark:text-white text-center max-w-xl mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <Links
            ...
            className="flex items-center gap-3 px-6 py-3 hover:bg-[#3396D3] border border-gray-300 dark:border-gray-600 rounded-lg  transition"
            text="Email Me"
          >
          ...
          <Links
            ...
            target="_blank"
            className="flex items-center gap-3 px-6 py-3 border hover:bg-[#3396D3] border-gray-300 dark:border-gray-600 rounded-lg  transition"
            text="LinkedIn"
          >
          ...
          <Links
            ...
            target="_blank"
            className="flex items-center gap-3 px-6 py-3 border hover:bg-[#3396D3] border-gray-300 dark:border-gray-600 text-green-500 rounded-lg transition"
            text="WhatsApp"
          >
